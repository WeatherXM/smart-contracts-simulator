...
import WeatherXMData from './artifacts/smart-contracts/src/WeatherXMData.sol/WeatherXMData.json';
import WeatherXM from './artifacts/smart-contracts/src/WeatherXM.sol/WeatherXM.json';
import WeatherStationXM from './artifacts/smart-contracts/src/WeatherStationXM.sol/WeatherStationXM.json';
import RewardPool from './artifacts/smart-contracts/src/RewardPool.sol/RewardPool.json';
import BurnPool from './artifacts/smart-contracts/src/BurnPool.sol/BurnPool.json';
import PriceFeedConsumer from './artifacts/smart-contracts/src/PriceFeedConsumer.sol/PriceFeedConsumer.json';
import MockV3Aggregator from './artifacts/smart-contracts/src/mocks/oracle/MockV3Aggregator.sol/MockV3Aggregator.json';
import fs from 'fs';
